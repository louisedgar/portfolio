    ...
    return (
        ...
        <div>
          <div className="max-w-5xl mx-auto ">
            {/* Co. */}
            <div className=" justify-center mt-32 md:mt-40 mb-0 mx-auto">
              ...
              <div className="md:flex md:flex-row md:flex-auto md:mt-4 md:items-start">
                ...
                <div className="mx-6 mt-2 md:mt-4 text-lg text-gray-700 md:text-xl md:w-2/4 md:mx-0 flex-initial">
            ...
            <div className=" justify-center mt-24 mb-0 mx-auto">
              ...
              <div className="md:flex md:flex-row md:flex-auto md:mt-4 md:items-start">
                ...
                <div className="mx-6 mt-2 md:mt-4 text-lg text-gray-700 md:text-xl md:w-2/4 md:mx-0 flex-initial">
                  ...
                  by the person in charge to measure the quality of the air. Our
