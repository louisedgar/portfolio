            ...
            <div className="md:text-left md:justify-start mt-16 md:mt-24 mb-0">
              <div className="flex flex-col flex-col-reverse md:flex-row md:flex-auto md:text-left md:justify-start">
                <div className="mx-4 mt-6 text-gray-900 font-light md:text-xl md:w-1/3 flex-initial md:text-left md:justify-start md:ml-0 md:mr-16">
                  ...
                  <div className="mt-2 mb-6 text-gray-900">
                   ...
                   <a href="https://medium.com/design-bootcamp/case-study-water-pressure-monitoring-web-app-21be037e0097" target="blank" className="text-indigo-600 hover:opacity-50">
                    Read case study
                   </a>
                </div>
              ...
              <div className="md:mx-auto md:flex md:flex-row md:flex-auto md:items-start">
                ...
                <div className="font-bold text-2xl md:text-2xl hover:text-indigo-600 mt-2">
                  ...
                  <a href="https://medium.com/design-bootcamp/building-a-custom-form-builder-fb879ae53085" target="blank" className="text-indigo-600 hover:opacity-50">
                    Read case study
                   </a>
                  </div>
                </div>
            ...
            {/* AQimos */}
              ...
              <div className="flex flex-col flex-col-reverse md:flex-row md:flex-auto md:text-left md:justify-start">
                ...
                <div className="font-bold mt-2 text-2xl md:text-2xl hover:text-indigo-600">
                  ...
                  <a href="https://louisedgar.medium.com/redesigning-aqimos-4f415ef6e39e" target="blank" className="text-indigo-600 hover:opacity-50">
                    Read case study
                   </a>
                </div>
                <div className="text-2xl font-semibold text-gray-900 mt-6 md:mx-0 md:w-2/3 flex-initial">
            ...
            {/* Co. */}
              ...
              <div className="md:mx-auto md:flex md:flex-row md:flex-auto md:items-start">
                ...
                <div className="font-bold mt-2 text-2xl md:text-2xl hover:text-indigo-600">
                  ...
                  <a href="https://louisedgar.medium.com/co-a-collaboration-messaging-platform-simplified-6ce26389345d" target="blank" className="text-indigo-600 hover:opacity-50">
                    Read case study
                   </a>
